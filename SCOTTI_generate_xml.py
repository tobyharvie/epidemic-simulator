...
xml.write("<beast version='2.7' namespace='beast.base.evolution.alignment:beast.pkgmgmt:"+
                     "beast.base.core:beast.base.inference:beast.pkgmgmt:"+
                     "beast.base.core:beast.base.inference.parameter:"+
                     "beast.base.evolution.tree:beast.base.evolution.tree.coalescent:"+
                     "beast.base.inference.util:beast.base.math:beast.base.evolution.operator:"+
                     ...
                     "beast.beast.base.inference.distribution.Priorbase.evolution.tree:beast.base.inference.distribution:"+
                     "scotti.evolution.tree:scotti.distributions:scotti.operators:scotti.util'>\n\n"+"  <data id=\"alignmentVar\" dataType=\"nucleotide\">\n")
for s in seqs.keys():
...
#priors
xml.write("   <input spec=\'CompoundDistribution\' id=\'parameterPriors\'>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@mutationRate\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"-3.0\" S=\"6.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@popSize\">\n       <distr spec=\"LogNormalDistributionModel\"  M=\"0.0\" S=\"6.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rate\">\n       <distr spec=\'LogNormalDistributionModel\' M=\""+str(math.log(1.0/(meanL*nHos)))+"\" S=\"0.2\"/>\n     </distribution>\n")
if args.mutationModel=="HKY":
    xml.write("     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@hky.kappa\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n   </input>\n\n")
elif args.mutationModel=="JC":
   xml.write("   </input>\n\n")
elif args.mutationModel=="GTR":
    xml.write("     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rateAC\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rateAG\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rateAT\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rateCG\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n     <distribution spec=\'beast.base.inference.distribution.Prior\' x=\"@rateGT\">\n       <distr spec=\'LogNormalDistributionModel\' M=\"0.0\" S=\"4.0\"/>\n     </distribution>\n   </input>\n\n")      
